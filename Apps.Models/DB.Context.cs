...
namespace Apps.Models
{
    ...
    public partial class DBContainer : DbContext
    {
        ...
        public virtual DbSet<SysModuleRight> SysModuleRight { get; set; }
        public virtual DbSet<SysModuleRightOperate> SysModuleRightOperate { get; set; }
        ...
        public virtual int P_Sys_InsertSysRight(string roleId)
        {
            var roleIdParameter = roleId != null ?
                new ObjectParameter("roleId", roleId) :
                new ObjectParameter("roleId", typeof(string));
    
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("P_Sys_InsertSysRight", roleIdParameter);
        }
        ...
        public virtual int P_WebPart_GetInfo1(Nullable<int> rows, string userId)
        {
            var rowsParameter = rows.HasValue ?
                new ObjectParameter("Rows", rows) :
                new ObjectParameter("Rows", typeof(int));
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("P_WebPart_GetInfo1", rowsParameter, userIdParameter);
        }
    
        public virtual int P_Sys_InsertSysUserModuleRight(string userId)
        {
            var userIdParameter = userId != null ?
                new ObjectParameter("UserId", userId) :
                new ObjectParameter("UserId", typeof(string));
    
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("P_Sys_InsertSysUserModuleRight", userIdParameter);
        }
    
        public virtual int P_TOOL_Query(string queryType, Nullable<int> pageno, Nullable<int> rows, string order, ObjectParameter rowscount, string table, string id)
        {
            var queryTypeParameter = queryType != null ?
                new ObjectParameter("queryType", queryType) :
                new ObjectParameter("queryType", typeof(string));
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("P_TOOL_Query", queryTypeParameter, pagenoParameter, rowsParameter, orderParameter, rowscount, tableParameter, idParameter);
        }
    
        public virtual ObjectResult<P_Sys_GetModuleByUser_Result> P_Sys_GetModuleByUser(string userId, string id)
        {
            var userIdParameter = userId != null ?
                new ObjectParameter("userId", userId) :
                new ObjectParameter("userId", typeof(string));
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<P_Sys_GetModuleByUser_Result>("P_Sys_GetModuleByUser", userIdParameter, idParameter);
        }
    
        public virtual ObjectResult<P_Sys_GetRightByUserAndModule_Result> P_Sys_GetRightByUserAndModule(string userId, string moduleId)
        {
            var userIdParameter = userId != null ?
                new ObjectParameter("UserId", userId) :
                new ObjectParameter("UserId", typeof(string));
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<P_Sys_GetRightByUserAndModule_Result>("P_Sys_GetRightByUserAndModule", userIdParameter, moduleIdParameter);
        }
    
        public virtual ObjectResult<P_Sys_GetModuleByRole_Result> P_Sys_GetModuleByRole(string id, string roleId)
        {
            var idParameter = id != null ?
                new ObjectParameter("Id", id) :
                new ObjectParameter("Id", typeof(string));
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<P_Sys_GetModuleByRole_Result>("P_Sys_GetModuleByRole", idParameter, roleIdParameter);
        }
    
        public virtual int P_Sys_UpdateSysRightRight0(string moduleIds, string roleId)
        {
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("P_Sys_UpdateSysRightRight0", moduleIdsParameter, roleIdParameter);
        }
    
        public virtual int P_Sys_UpdateSysUserModuleRight(string moduleId, string userId)
        {
            var moduleIdParameter = moduleId != null ?
                new ObjectParameter("moduleId", moduleId) :
                new ObjectParameter("moduleId", typeof(string));
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("P_Sys_UpdateSysUserModuleRight", moduleIdParameter, userIdParameter);
        }
    
        public virtual int P_Sys_UpdateUserModuleRight(string moduleIds, string userId)
        {
            var moduleIdsParameter = moduleIds != null ?
                new ObjectParameter("moduleIds", moduleIds) :
                new ObjectParameter("moduleIds", typeof(string));
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("P_Sys_UpdateUserModuleRight", moduleIdsParameter, userIdParameter);
        }
    }
}
