...
namespace Apps.BLL
{
	public class Virtual_SysModuleRightBLL
	{
        [Dependency]
        public ISysModuleRightRepository m_Rep { get; set; }

		public virtual List<SysModuleRightModel> GetList(ref GridPager pager, string queryStr)
        {

            IQueryable<SysModuleRight> queryData = null;
        ...
        public virtual List<SysModuleRightModel> CreateModelList(ref IQueryable<SysModuleRight> queryData)
        {

            List<SysModuleRightModel> modelList = (from r in queryData
